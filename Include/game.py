...
class GAME(Cacing):
    ...
    def run(game):
        ...
        while game.aktif:
            ...
            if m.wline == 0:
                JUDUL_PADA_WINDOWS = f'Game Cacing Kelompok 1 | Tema : {nama_tema_ke_0}'
                display.set_caption(JUDUL_PADA_WINDOWS)
            elif m.wline == 1:
                JUDUL_PADA_WINDOWS = f'Game Cacing Kelompok 1 | Tema : {nama_tema_ke_1}'
                display.set_caption(JUDUL_PADA_WINDOWS)
            elif m.wline == 2:
                JUDUL_PADA_WINDOWS = f'Game Cacing Kelompok 1 | Tema : {nama_tema_ke_2}'
                display.set_caption(JUDUL_PADA_WINDOWS)
            elif m.wline == 3:
                JUDUL_PADA_WINDOWS = f'Game Cacing Kelompok 1 | Tema : {nama_tema_ke_3}'
                display.set_caption(JUDUL_PADA_WINDOWS)
...
if __name__ == "__main__":
    ...
    def loading_frame():
        ...
        while (tampilan_loading.percent != 0 and frame_index_loading_icColour != 4) or looping:
            ...
            tampilan_loading.completedColour = frame_warna_loading[int(frame_index_loading_icColour)]
            ...
            display.set_caption(f'Loading{fr_tesk_dot_notSurface[int(frame_index_teks_dot)]}')
